...
\begin{subfigure}[t]{0.47\columnwidth}
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=1.1\columnwidth]{ShellFamiliarity}}
...
\begin{subfigure}[t]{0.47\columnwidth}
	\centering
	\makebox[\textwidth][c]{\includegraphics[width=1.1\columnwidth]{ShellSkill}}
...
\begin{subfigure}[c]{2.1in}
	\centering
    	\makebox[\textwidth][c]{\includegraphics[width=2.4in]{ShellDetailSkill1}}
    	\caption{
    ...
    \begin{subfigure}[c]{2.1in}
        \centering
    	\makebox[\textwidth][c]{\includegraphics[width=2.4in]{ShellDetailSkill2}}
    	\caption{
    ...
    \begin{subfigure}[c]{2.1in}
    	\centering
    	\makebox[\textwidth][c]{\includegraphics[width=2.4in]{ShellDetailSkill3}}
    	\caption{
