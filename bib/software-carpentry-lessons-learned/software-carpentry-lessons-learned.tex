...
\fixme{talk about evolution of lesson templates and bikeshedding}
...
pre-assessment questionnaire that asks them how easily they could
do a small number of specific tasks. \fixme{critique the pre-assessment}
...
We therefore still recommend using \href{Nano}{fixme} as an editor in
class, even though none of our instructors use it for real work.
Arguments over this are another example of the bikeshedding discussed
in Section~\ref{s:lesson-templates}: many people who are passionate
about programming are also passionate (some might say ``zealous'')
about text editors.  Left unchecked, they will debate the relative
merits of various editors \emph{ad nauseum} in preference to
discussing teaching objectives, not least because they feel more sure
of their ground.
